...
class UpdateImageProfileWidget extends StatelessWidget {
  const UpdateImageProfileWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      leading: SvgGenSizeWidget(
        icon:
            Assets.icons.userCircle.svg(color: Theme.of(context).primaryColor),
      ),
      title: Text(
